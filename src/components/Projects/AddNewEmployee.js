                ...
                <Grid container spacing={2} mt={2}>
                    <Grid item xs={12} md={6}>
                        <Box display="flex" alignItems="center">
                            <InputLabel
                                shrink
                                sx={{ flexBasis: "35%", fontWeight: "500", fontSize: "20px" }}
                            >
                                Name
                            </InputLabel>
                            <TextField
                    ...
                    <Grid item xs={12} md={6}>
                        <Box display="flex" alignItems="center">
                            <InputLabel
                                shrink
                                sx={{ flexBasis: "55%", fontWeight: "500", fontSize: "20px" }}
                            >
                                Show this Employee to Website
                            </InputLabel>
                            <FormControlLabel
                                control={
                                    <Checkbox
                                ...
                                label=""
                                sx={{ marginLeft: "auto" }} // Aligns checkbox to the right side
                            />
                        </Box>
                    </Grid>
                </Grid>
